...
unlocked to sign the NovaNickel-Qt.app bundle.
...
allowing somebody to distribute a NovaNickel-Qt.app or novanickel-qt-setup.exe with a valid
...
that the novanickel-qt.exe file inside the installer had not been tampered with.
