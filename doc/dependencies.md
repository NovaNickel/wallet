...
These are the dependencies currently used by NovaNickel. You can find instructions for installing them in the `build-*.md` file for your platform.
...
Telegram - https://t.me/novanickelnl
Keybase  - https://keybase.io/team/novanickel/
