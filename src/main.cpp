...
#if defined(NDEBUG)
# error "NovaNickel cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "NovaNickel Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("novanickel-scriptch");
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // NovaNickel also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // NovaNickel also requires low S in sigs
