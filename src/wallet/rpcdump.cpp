...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"novanickeladdress\"\n"
            "\nReveals the private key corresponding to 'novanickeladdress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"novanickeladdress\"   (string, required) The novanickel address for the private key\n"
            "\nResult:\n"
