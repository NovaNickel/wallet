 ...
 * between novanickeld, and novanickel-qt and non-server tools.
*/
...
void Shutdown()
{
    ...
    RenameThread("novanickel-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/NovaNickel>";
    const std::string URL_WEBSITE = "<https://novanickel.net/>";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf("Copyright (C) %i The NovaNickel Developers", 2024)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find NovaNickel useful. "
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("novanickel-loadblk");
    CImportingNow imp;
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("NovaNickel More version %s\n", FormatFullVersion());
}
