...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s novanickel-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  novanickel-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded novanickel transaction") + "\n" +
              "  novanickel-tx [options] -create [commands]   " + _("Create hex-encoded novanickel transaction") + "\n" +
              "\n";
