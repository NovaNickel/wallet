...
const QString BITCOIN_IPC_PREFIX("novanickel:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/novanickel-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/novanickel-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/novanickel-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click novanickel: links
...
//
// OSX-specific way of handling novanickel: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in novanickel: URIs
