...
BOOST_AUTO_TEST_CASE(cashaddr_testvectors_valid)
{
    static const std::string CASES[] = {
        "prefix:x64nx6hz", "PREFIX:X64NX6HZ", "p:gpf8m4h7", "novanickel:qpzry9x8gf2tvdw0s3jn54khce6mua7lcw20ayyn",
        "nntest:testnetaddress4d6njnut", "nnreg:555555555555555555555555555555555555555555555udxmlmrz",
    };
...
BOOST_AUTO_TEST_CASE(cashaddr_testvectors_invalid)
{
    static const std::string CASES[] = {
        ...
        "nnreg:555555555555555555x55555555555555555555555555udxmlmrz",
        "nnreg:555555555555555555555555555555551555555555555udxmlmrz", "pre:fix:x32nx6hz", "prefixx64nx6hz",
    };
...
BOOST_AUTO_TEST_CASE(cashaddr_testvectors_noprefix)
{
    static const std::pair<std::string, std::string> CASES[] = {
        {"novanickel", "qpzry9x8gf2tvdw0s3jn54khce6mua7lcw20ayyn"}, {"prefix", "x64nx6hz"}, {"PREFIX", "X64NX6HZ"},
        {"p", "gpf8m4h7"}, {"novanickel", "qpzry9x8gf2tvdw0s3jn54khce6mua7lcw20ayyn"},
        {"nntest", "testnetaddress4d6njnut"}, {"nnreg", "555555555555555555555555555555555555555555555udxmlmrz"},
    };
